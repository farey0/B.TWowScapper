...
const ItemSets = [[11, "Druid"], [3, "Hunter"], [8, "Mage"], [2, "Paladin"], [5, "Priest"], [4, "Rogue"], [7, "Shaman"], [9, "Warlock"], [1, "Warrior"]];
const Npcs = [[1, "Beasts"], [8, "Critters"], [3, "Demons"], [2, "Dragonkin"], [4, "Elementals"], [5, "Giants"], [7, "Humanoids"], [9, "Mechanicals"], [12, "Small Pets"], [6, "Undead"], [10, "Uncategorized"]];
const Objects = [[9, "Books"], [3, "Containers"], [-5, "Footlockers"], [-3, "Herbs"], [-4, "Mineral Veins"], [-2, "Quest"]];
const Quests = [
    [0, "Eastern Kingdoms", ,
        [
...
export const Database = [
    ...
    [1, "Spells", "?spells", Spells], /*[6, "Zones", "?zones", mn_zones],*/
    [7, "Factions", "?factions"]//,
    // [, "Utilities"],
    // [30, "Latest Comments", "?latest=comments"] /*, [31, "Latest Screenshots", "?latest=screenshots"] */
];
// const mn_tools = [[0, "Maps", "?maps"]]; //[0, "Talent Calculator", "?talent", mn_talentCalc],  not working yet
// const mn_path = [[0, "Database", , mn_database], [1, "Tools", , mn_tools]];
const Path = [[0, "Database", , Database]];
const ChrClasses = {
    11: "Druid",
    3: "Hunter",
    8: "Mage",
